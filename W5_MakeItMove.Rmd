...
# that is because log10 is a default option for rmarkdown

2. *Who is the outlier (the richest country in 1952 - far right on x axis)?* 
#The answer is Kuwait, look below to see the answer the function I wrote to answer
...
# in option 1 i went op and changed it  by adding somthing right after scale_x_log10()
